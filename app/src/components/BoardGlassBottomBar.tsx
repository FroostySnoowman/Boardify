...
const TRIPLE_INNER_WIDTH = TRIPLE_SLOT * STRIP_ICON_COUNT + TRIPLE_ICON_GAP * (STRIP_ICON_COUNT - 1);
...
export const BOARD_GLASS_FOCUS_DOTS_BASE_CLEARANCE = PILL_TRACK_HEIGHT + 22;
