...
/** Space from the physical bottom to sit focus-mode page dots just above the visible glass pill (add safe-area in the screen). */
export const BOARD_GLASS_FOCUS_DOTS_BASE_CLEARANCE = PILL_TRACK_HEIGHT + 10;
