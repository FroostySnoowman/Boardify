...
- **File:** `src/config/attribution.ts`
- **Constant:** `KLIPY_ATTRIBUTION_ENABLED`
  - `1` = attribution **on** (use this for production / when using the KLIPY API)
  - `0` = attribution **off** (no “Powered by KLIPY” or watermark; generic “GIF” label only)