/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 54a3f6906b98ad20ee63db11d7221ce5)
// Runtime types generated with workerd@1.20260212.0 2025-11-17 global_fetch_strictly_public
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchSpectate" | "MessageWebSocket" | "MatchRadio" | "LiveMatchesList";
	}
	interface DevEnv {
		IMAGES: R2Bucket;
		DB: D1Database;
		...
		MATCH_SPECTATE: DurableObjectNamespace /* MatchSpectate from api-dev */;
		MATCH_RADIO: DurableObjectNamespace /* MatchRadio from api-dev */;
		LIVE_MATCHES_LIST: DurableObjectNamespace /* LiveMatchesList from api-dev */;
		MESSAGE_WS: DurableObjectNamespace /* MessageWebSocket from api-dev */;
	}
	interface ProductionEnv {
		...
		SMTP_PASS: string;
		OPENAI_API_KEY: string;
		MATCH_SPECTATE: DurableObjectNamespace /* MatchSpectate from api */;
		MATCH_RADIO: DurableObjectNamespace /* MatchRadio from api */;
		LIVE_MATCHES_LIST: DurableObjectNamespace /* LiveMatchesList from api */;
		MESSAGE_WS: DurableObjectNamespace /* MessageWebSocket from api */;
	}
	interface Env {
		LIVE_ACTIVITY_TEST_SECRET: string;
		APNS_PRODUCTION: string;
		...
		IMAGES: R2Bucket;
		DB: D1Database;
		MATCH_SPECTATE: DurableObjectNamespace /* MatchSpectate from api-dev */ | DurableObjectNamespace /* MatchSpectate from api */;
		MATCH_RADIO: DurableObjectNamespace /* MatchRadio from api-dev */ | DurableObjectNamespace /* MatchRadio from api */;
		LIVE_MATCHES_LIST: DurableObjectNamespace /* LiveMatchesList from api-dev */ | DurableObjectNamespace /* LiveMatchesList from api */;
		MESSAGE_WS: DurableObjectNamespace /* MessageWebSocket from api-dev */ | DurableObjectNamespace /* MessageWebSocket from api */;
	}
}
